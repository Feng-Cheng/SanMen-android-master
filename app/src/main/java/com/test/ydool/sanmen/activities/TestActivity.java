...
import com.test.ydool.sanmen.utils.Utils;
...
//        player.setUpLazy("https://dn-tankplus.qbox.me/ydool_1.mp4", true, null, null, "");
...
//        player.setAutoFullWithSize(true);
        ...
        mVideoView = findViewById(R.id.qiqiu);
...
//        mVideoView.setVideoPath("http://zs.ydool.com:8082/upload/Exhibition/%E7%88%B1%E5%9C%A8%E4%B8%89%E9%97%A8%E4%B9%90%E5%9C%A8%E7%A4%BC%E5%A0%82%20%E9%97%B9%E5%85%83%E5%AE%B5.mp4");
        mVideoView.setVideoPath("http://zs.ydool.com:8082/upload/Exhibition/爱在三门乐在礼堂%20闹元宵.mp4");
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case PLOnInfoListener.MEDIA_INFO_VIDEO_RENDERING_START:
                    Utils.showToastTips(mContext, "first video render time: " + extra + "ms");
                    break;
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                ...
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    Utils.showToastTips(mContext, "failed to open player !");
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    Utils.showToastTips(mContext, "failed to seek !");
                    break;
                default:
                    Utils.showToastTips(mContext, "unknown error !");
                    break;
            }
            finish();
            return true;
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            Utils.showToastTips(mContext, "Play Completed !");
            if (!mIsLiveStreaming) {
